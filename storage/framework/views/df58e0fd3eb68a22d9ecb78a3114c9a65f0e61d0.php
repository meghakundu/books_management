...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body>
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                <!--begin::Card-->
                <a href="/create-books"><button>Create Books</button></a>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item['author']['first_name']); ?><?php echo e($item['author']['last_name']); ?></td>
                                        <td><a class="btn btn-sm btn-clean btn-icon mr-2"
                                                    href="/books/<?php echo e($item['id']); ?>/edit">
                                                ...
                                                <form action="<?php echo e(route('books.delete',$item['id'])); ?>" method="POST" id="edit_form">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH E:\xampp\htdocs\books_management\resources\views/books/index.blade.php ENDPATH**/ ?>